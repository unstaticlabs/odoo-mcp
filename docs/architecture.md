...
- `/mcp` is the broad default static view, capped at 22 tools and 15,000 estimated schema tokens; it omits deferred-loading hints so hosted clients retain every listed schema.
