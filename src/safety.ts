...
// ---- Advisory bookkeeping preview (read-only) ----
...
/** The pure result of a per-operation advisory planner. */
export interface PlanResult {
  ...
  /** True only for a `duplicate_found` that resolves to an in-place update. */
