...
const PM_WRITE_ROUTING_NOTE =
  " Project-management notes (including banking/B2C/deadline operational text) on project.task / project.project / mail.activity→project.* are allowed. For accounting mutations use bookkeeping.plan_safe_write only. See docs/projects.md.";
