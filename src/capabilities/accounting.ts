...
export function registerAccountingCapabilities(registry: CapabilityRegistry, client: OdooClient): void {
  registry.add(defineCapability({
    ...
    requiredModelAccess: [{ model: "rebuild.account.overview", operation: "read" }],
    defaultVisible: true,
    alwaysLoad: false,
    sortOrder: 235,
  ...
  registry.add(defineCapability({
    ...
    requiredModules: ["rebuild_account_migration"],
    requiredModelAccess: [{ model: "rebuild.account.management.summary.line", operation: "read" }],
    defaultVisible: false,
    alwaysLoad: false,
    sortOrder: 290,
    input: z.object({
  ...
  registry.add(defineCapability({
    ...
    requiredModules: ["rebuild_account_migration"],
    requiredModelAccess: [{ model: "rebuild.account.tax.report.line", operation: "read" }],
    defaultVisible: false,
    alwaysLoad: false,
    sortOrder: 295,
    input: z.object({
